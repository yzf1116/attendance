  ...
  export default {
    data() {
      ...
      return {
            ...
            tableData: [],
            cols: [
                {prop: 'police_name', label: '警员姓名',children:[]},
                ...
                {label: '上班考勤',children:[
                    {prop: 'work_time', label: '上班时间',children:[],format:this.dtformatFun},
                    {prop: 'work_status', label: '考勤状态',children:[]},
                ]},
                {label: '下班考勤',children:[
                    {prop: 'off_work_time', label: '下班时间',children:[],format:this.dtformatFun},
                    {prop: 'off_work_status', label: '考勤状态',children:[]},
                ]},
            ],
            tabPage: {
                currentPage: 1,
