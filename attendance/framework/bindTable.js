 ...
 * 申请记录表
 */
db['rev_apply'].hasMany(db['rev_approval'],{foreignKey: 'apply_code', targetKey: 'review_code'});//

/**
 * 审批记录表
 */
db['rev_approval'].belongsTo(db['rev_apply'],{foreignKey: 'apply_code',targetKey: 'review_code'});//
